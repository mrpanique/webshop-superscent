    ...
    <div class="row">
            ...
            <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="img/hawas.png" class="d-block w-100 img-adv">
                    </div>
                    <div class="carousel-item">
                        <img src="img/hawas_adv.jpg" class="d-block w-100 img-adv">
                    </div>
                </div>
        ...
        <div class="col-md-4">
            ...
            <form action="includes/product_page.inc.php" method="POST">
                ...
                <input type="hidden" name="product-name" value="rasasi_hawas">
        ...
        <div class="row mt-4">
            <div class="col-md-12">
                ...
                <p>Ebben az illatkompozícióban friss, vizes illatjegyek társulnak, melyek fokozatosan melengető, fás
                    alapba olvadnak szét. Először a citrom és alma alkotta, üde, gyümölcsös keverék jelenik meg a
                    rendhagyó fahéj és bergamott kíséretében. Az azonnal megjelenő szívillat dinnyével és ibolyával
                    kombinált vizes akkordokra épül. Ezután színre lépnek a szantálfa, cédrusfa és pézsma melengető,
                    keleties illatjegyei.</p>
            </div>
        </div>
        ...
        <div class="row mt-2">
            <div class="col-md-12">
                ...
                <p>ALCOHOL DENAT., AQUA/WATER/EAU, PARFUM/FRAGRANCE, METHYL CYCLODEXTRIN, ETHYLHEXYL SALICYLATE,
                    ...
                    VIOLET NO. 2 (CI 60730), FD&C BLUE NO. A termék
        ...
        <div class="row mt-2">
            <div class="col-md-12">
                <h4 class="mb-3">Rasasi márkáról</h4>
                <p>A Rasasi egy családi tulajdonban lévő dubai parfümház, amit 1979-ben Mr. Abdul Razzak Kalsekar
                    alapított. A márka ma a világ több mint 50 országában kapható. Kínálatukban keleties és nyugatias
                    illatok egyaránt megtalálhatók.</p>
            </div>
        </div>
    </div>
</div>
